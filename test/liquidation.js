...
describe("Liquidation", function () {
  it("test", async function () {
      ...
      params: [
        {
          forking: {
            jsonRpcUrl:
              "https://eth-mainnet.g.alchemy.com/v2/TUQ0TXpuJZLMsGH5lZUa__5ErrSEGme4",
    ...
    const gasPrice = 0;
    const debt_USDC = ethers.utils.parseUnits("8128956343", 0);
    // const debt_USDC = ethers.utils.parseUnits("8600", 6);
    ...
    console.log(
      `debt liquidated : ${debt_USDC} USDC \nprofit: `,
